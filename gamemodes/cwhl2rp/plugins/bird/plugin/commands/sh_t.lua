...
local COMMAND = Clockwork.command:New("T");
COMMAND.tip = "Tweet like the little birdy you are.";
...
function COMMAND:OnRun(player, arguments)
	...
	if player:GetFaction() == FACTION_BIRD then
		...
		Clockwork.player:Notify(player, "Don't tweet, you'll look like an idiot!")
	end
end;
