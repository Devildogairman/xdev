...
ITEM.name = "Universal Union Grade Loyalty Ration";
ITEM.model = "models/weapons/w_packatp.mdl";
ITEM.weight = 2;
ITEM.uniqueID = "uu_grade_ration";
ITEM.useText = "Open";
ITEM.category = "Impera Custom Rations";
ITEM.description = "A Golden Yellow Packet, its contents seem to be of high loyalty quality.";

ITEM.food = {"peanut_uu", "banana_uu", "orange_uu", "coffee_uu", "cheese_uu", "cereal_uu", "crisps_uu",
			 "corn_uu", "beer_uu", "gin_uu", "bread_uu"};
ITEM.book = {"book_c"};
ITEM.misc = {"request_device", "uu_bandage", "boxed_bag"};
...
function ITEM:OnUse(player, itemEntity)
	Clockwork.player:GiveCash(player, 150, "UU Ration Packet");

	player:GiveItem(Clockwork.item:CreateInstance("suppl_citizen_loyal_prio"), true);
	...
	player:GiveItem(Clockwork.item:CreateInstance("chocolate_uu"), true);
