...
ITEM.name = "High Grade Loyalty Ration";
...
function ITEM:OnUse(player, itemEntity)
	Clockwork.player:GiveCash(player, 150, "high grade ration packet");
	...
	player:GiveItem(Clockwork.item:CreateInstance("uu_peanuts"), true);
